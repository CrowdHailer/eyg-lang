...
//       let #(c, rev, e, k) = r.step_call(f, r.Record([]), [], env.empty(), None)
//       r.K(c, rev, e, k)
//     },
//   )
...
//             // env should probably come from capture
//             let #(c, rev, e, k) =
//               r.step_call(f, r.Binary("B"), [], env.empty(), None)
//             r.K(c, rev, e, k)
//           },
//         )
//       r.K(c, rev, e, k)
...
//     fn(f) {
//       // env should probably come from capture
//       let #(c, rev, e, k) = r.step_call(f, arg, [], env, None)
//       r.K(c, rev, e, k)
//     },
//   )
...
//     fn(f) {
//       // env should probably come from capture
//       let #(c, rev, e, k) = r.step_call(f, arg, [], env.empty(), None)
//       r.K(c, rev, e, k)
//     },
//   )
...
//     fn(f) {
//       // env should probably come from capture
//       let #(c, rev, e, k) = r.step_call(f, exec, [], env.empty(), None)
//       r.K(c, rev, e, k)
//     },
//   )
...
//       // env should probably come from capture
//       let #(c, rev, e, k) =
//         r.step_call(f, r.Binary("not a function"), [], env, None)
//       r.K(c, rev, e, k)
//     },
//   )
...
//     fn(f) {
//       // env should probably come from capture
//       let #(c, rev, e, k) = r.step_call(f, reduce, [], env, None)
//       r.K(c, rev, e, k)
//     },
//   )
