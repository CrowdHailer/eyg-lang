      ...
      ir.Let(
        ...
        #(
          ir.Let(
            "b",
            #(
              ir.Apply(#(ir.Select("y"), #(8, 9)), #(ir.Variable("$"), #(9, 10))),
              #(8, 10),
            ),
            #(ir.Integer(5), #(20, 21)),
          ),
...
pub fn apply_test() {
  ...
  |> should.be_ok()
  |> should.equal(#(
    ir.Apply(#(ir.Variable("a"), #(0, 1)), #(ir.Integer(1), #(2, 3))),
    #(0, 4),
  ))
  "a(10)(20)"
  |> parser.all_from_string()
...
pub fn let_test() -> Nil {
  ...
  |> should.be_ok()
  |> should.equal(#(
    ir.Let("x", #(ir.Integer(5), #(8, 9)), #(
      ir.Apply(#(ir.Select("foo"), #(14, 18)), #(ir.Variable("x"), #(13, 14))),
      #(13, 18),
    )),
    #(0, 18),
  ))
  ...
  |> should.equal(#(
    ir.Let(
      "x",
      #(
        ir.Let("y", #(ir.Integer(3), #(20, 21)), #(ir.Variable("y"), #(26, 27))),
        #(12, 27),
      ),
      #(ir.Variable("x"), #(31, 32)),
    ),
  ...
  |> should.equal(#(
    ir.Let("x", #(ir.Integer(5), #(8, 9)), #(
      ir.Let("y", #(ir.Integer(1), #(21, 22)), #(ir.Variable("x"), #(26, 27))),
      #(13, 27),
    )),
    #(0, 27),
  ))
...
pub fn let_record_test() -> Nil {
      ...
      ir.Let(
        ...
        #(
          ir.Let(
            "y",
            #(
              ir.Apply(#(ir.Select("y"), #(8, 9)), #(ir.Variable("$"), #(8, 9))),
              #(8, 9),
            ),
            #(ir.Variable("a"), #(20, 21)),
          ),
  ...
  |> should.be_ok()
  |> should.equal(#(
    ir.Let("$", #(ir.Variable("rec"), #(9, 12)), #(ir.Variable("a"), #(16, 17))),
    #(0, 17),
  ))
}
...
pub fn tagged_test() {
  ...
  |> should.be_ok()
  |> should.equal(#(
    ir.Apply(#(ir.Tag("Ok"), #(0, 2)), #(ir.Integer(2), #(3, 4))),
    #(0, 5),
  ))
}
...
pub fn match_test() {
  ...
  |> should.be_ok()
  |> should.equal(#(
    ir.Apply(#(ir.NoCases, #(8, 11)), #(ir.Variable("x"), #(6, 7))),
    #(0, 11),
  ))
  "match {
      Ok x
  ...
  |> should.equal(#(
    ir.Apply(
      ...
      #(
        ir.Apply(
          #(
            ir.Apply(#(ir.Case("Error"), #(25, 30)), #(
              ir.Lambda("y", #(ir.Variable("y"), #(39, 40))),
              #(30, 42),
            )),
            #(25, 42),
          ),
  ...
  |> should.equal(#(
    ir.Apply(
      #(
        ir.Apply(
          #(
            ir.Apply(#(ir.Case("Ok"), #(18, 20)), #(
              ir.Lambda("a", #(ir.Variable("a"), #(29, 30))),
              #(20, 32),
            )),
            #(18, 32),
          ),
...
pub fn comment_test() {
  ...
  |> should.be_ok()
  |> should.equal(#(
    ir.Let("y", #(ir.Integer(1), #(24, 25)), #(ir.Variable("y"), #(29, 30))),
    #(16, 30),
  ))
}
