...
//   let query = sig_data.list_entries_from_entry(signatory)
...
//   use archived <- utils.db_call(data.insert_release(entry, context.db))
//   archived
