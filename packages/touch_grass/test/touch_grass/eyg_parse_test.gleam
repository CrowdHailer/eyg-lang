...
pub fn encode_content_reference_test() {
  ...
  assert nodes
    == [v.Tagged("Reference", v.Tagged("Content", v.String(cid_string)))]
}
...
pub fn encode_package_reference_test() {
  ...
  assert nodes
    == [v.Tagged("Reference", v.Tagged("Package", v.String("standard")))]
}
...
pub fn encode_relative_reference_test() {
  ...
  assert nodes
    == [v.Tagged("Reference", v.Tagged("Relative", v.String("./module.eyg")))]
}
